...
public class SyntaxFactory implements IQueryFactory<Expression, 
    ...
    public IAggregateSymbol createAggregateSymbol(String functionName,
        ...
        return new AggregateSymbol(functionName, functionType.name(), isDistinct, expression);
    }
    ...
    @Override
    public IAliasSymbol createAliasSymbol(String name, SingleElementSymbol symbol) {
    ...
    @Override
    public ExpressionSymbol createExpressionSymbol(String name, Expression expression) {
    ...
    public ICreateProcedureCommand createCreateProcedureCommand(Block block) {
        return new CreateUpdateProcedureCommand(block);
    }
    ...
    @Override
    public ISelect createSelect(List<? extends SelectSymbol> symbols) {
