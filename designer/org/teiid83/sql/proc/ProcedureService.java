...
import org.teiid83.runtime.Messages;
import org.teiid83.sql.proc.wsdl.WsdlRequestProcedureHelper;
import org.teiid83.sql.proc.wsdl.WsdlResponseProcedureHelper;
import org.teiid83.sql.proc.wsdl.WsdlWrapperHelper;
    ...
    public String getSQLStatement(ITeiidXmlFileInfo xmlFileInfo, String relationalModelName) {
        ...
        */
        ...
        if( xmlFileInfo.isUrl() ) {
            ...
            finalSQLString = NLS.bind(Messages.procedureServiceXmlInvokeHttpTableSqlTemplate, tokens.toArray(new String[0]));
        } else {
